...
#Mixture of GinConv
#difference between mogin7: mogin8 uses shared experts like in DeepSeekMoe AND now has self-loops in edge_index (where was it this whole time?!)
