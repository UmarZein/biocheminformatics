...
class MoGIN11(nn.Module):
    def __init__(self, 
        ...
        self.edge_length_mean=nn.Parameter(torch.empty(1))
        self.edge_length_std=nn.Parameter(torch.empty(1))
        self.reset_parameters()
    ...
    def reset_parameters(self):
        ...
        constant(self.edge_length_mean,0.0)
        constant(self.edge_length_std,1.0)
