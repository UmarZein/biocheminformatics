...
#Mixture of GinConv
#difference between mogin9: mogin10 uses auxiliary-loss-less load balancing strategy
class MoGINConv(MessagePassing):
    def __init__(
        ...
        self.register_buffer('b',torch.zeros(self.num_experts))
